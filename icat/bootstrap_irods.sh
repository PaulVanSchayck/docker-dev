...
# Create resources and their replication mirror
...
iadmin modresc UM-hnas-4k comment Resource-for-UM
iadmin modresc UM-hnas-4k-repl comment Resource-for-UM
iadmin modresc AZM-storage comment Resource-for-AZM
iadmin modresc AZM-storage-repl comment Resource-for-AZM
...
for i in {01..2}; do
    ...
    project=$(irule -F /rules/projects/createProject.r "*authorizationPeriodEndDate='1-1-2018'" "*dataRetentionPeriodEndDate='1-1-2018'" "*ingestResource='${IRODS_RESOURCE_HOST_DEB}Resource'" "*resource='UM-hnas-4k'" "*replResource='UM-hnas-4k-repl'" "*storageQuotaGb='10'" "*title='${PROJECTNAME}'" "*principalInvestigator='p.vanschayck@${domain}'" "*respCostCenter='UM-30001234X'" "*pricePerGBPerYear='0.32'")
...
for i in {01..3}; do
    PROJECTNAME=$(fortune | head -n 1 | sed 's/\x27/ /g')
    project=$(irule -F /rules/projects/createProject.r "*authorizationPeriodEndDate='1-1-2018'" "*dataRetentionPeriodEndDate='1-1-2018'" "*ingestResource='${IRODS_RESOURCE_HOST_DEB}Resource'" "*resource='UM-hnas-4k'" "*replResource='UM-hnas-4k-repl'" "*storageQuotaGb='10'" "*title='${PROJECTNAME}'" "*principalInvestigator='p.suppers@${domain}'" "*respCostCenter='UM-30009998X'" "*pricePerGBPerYear='0.24'")
...
for i in {01..3}; do
    PROJECTNAME=$(fortune | head -n 1 | sed 's/\x27/ /g')
    project=$(irule -F /rules/projects/createProject.r "*authorizationPeriodEndDate='1-1-2018'" "*dataRetentionPeriodEndDate='1-1-2018'" "*ingestResource='${IRODS_RESOURCE_HOST_DEB}Resource'" "*resource='UM-hnas-4k'" "*replResource='UM-hnas-4k-repl'" "*storageQuotaGb='10'" "*title='${PROJECTNAME}'" "*principalInvestigator='d.theunissen@${domain}'" "*respCostCenter='UM-30009999X'" "*pricePerGBPerYear='0.16'")
...
for i in {01..4}; do
    PROJECTNAME=$(fortune | head -n 1 | sed 's/\x27/ /g')
    project=$(irule -F /rules/projects/createProject.r "*authorizationPeriodEndDate='1-1-2018'" "*dataRetentionPeriodEndDate='1-1-2018'" "*ingestResource='${IRODS_RESOURCE_HOST_DEB}Resource'" "*resource='UM-hnas-4k'" "*replResource='UM-hnas-4k-repl'" "*storageQuotaGb='10'" "*title='${PROJECTNAME}'" "*principalInvestigator='p.suppers@${domain}'" "*respCostCenter='UM-30009999X'" "*pricePerGBPerYear='0.32'")
...
for i in {01..2}; do
    PROJECTNAME=$(fortune | head -n 1 | sed 's/\x27/ /g')
    project=$(irule -F /rules/projects/createProject.r "*authorizationPeriodEndDate='1-1-2018'" "*dataRetentionPeriodEndDate='1-1-2018'" "*ingestResource='${IRODS_RESOURCE_HOST_DEB}Resource'" "*resource='UM-hnas-4k'" "*replResource='UM-hnas-4k-repl'" "*storageQuotaGb='10'" "*title='${PROJECTNAME}'" "*principalInvestigator='m.coonen@${domain}'" "*respCostCenter='UM-30009999X'" "*pricePerGBPerYear='0.32'")
